    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 47, 2, 1027);
    			add_location(b0, file, 49, 31, 1147);
    			attr_dev(label0, "for", "number");
    			attr_dev(label0, "class", "svelte-1u5rshg");
    			add_location(label0, file, 49, 4, 1120);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "name", "number");
    			attr_dev(input0, "class", "svelte-1u5rshg");
    			add_location(input0, file, 50, 4, 1170);
    			add_location(button0, file, 51, 4, 1232);
    			attr_dev(form0, "class", "svelte-1u5rshg");
    			add_location(form0, file, 48, 2, 1052);
    			add_location(b1, file, 54, 29, 1367);
    			attr_dev(label1, "for", "year");
    			attr_dev(label1, "class", "svelte-1u5rshg");
    			add_location(label1, file, 54, 4, 1342);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "year");
    			attr_dev(input1, "class", "svelte-1u5rshg");
    			add_location(input1, file, 55, 4, 1391);
    			add_location(button1, file, 56, 4, 1449);
    			attr_dev(form1, "class", "svelte-1u5rshg");
    			add_location(form1, file, 53, 2, 1276);
    			add_location(b2, file, 59, 29, 1584);
    			attr_dev(label2, "for", "date");
    			attr_dev(label2, "class", "svelte-1u5rshg");
    			add_location(label2, file, 59, 4, 1559);
    			attr_dev(input2, "type", "date");
    			attr_dev(input2, "name", "date");
    			attr_dev(input2, "class", "svelte-1u5rshg");
    			add_location(input2, file, 60, 4, 1608);
    			add_location(button2, file, 61, 4, 1664);
    			attr_dev(form2, "class", "svelte-1u5rshg");
    			add_location(form2, file, 58, 2, 1493);
    			attr_dev(h2, "class", "svelte-1u5rshg");
    			add_location(h2, file, 63, 2, 1708);
    			attr_dev(main, "class", "svelte-1u5rshg");
    			add_location(main, file, 46, 0, 1018);
    		},
