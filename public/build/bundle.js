    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t21 = space();
    			div = element("div");
    			attr_dev(h1, "class", "svelte-1glg9vd");
    			add_location(h1, file, 48, 2, 1054);
    			add_location(b0, file, 50, 31, 1174);
    			attr_dev(label0, "for", "number");
    			attr_dev(label0, "class", "svelte-1glg9vd");
    			add_location(label0, file, 50, 4, 1147);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "name", "number");
    			attr_dev(input0, "class", "svelte-1glg9vd");
    			add_location(input0, file, 51, 4, 1197);
    			add_location(button0, file, 52, 4, 1259);
    			attr_dev(form0, "class", "svelte-1glg9vd");
    			add_location(form0, file, 49, 2, 1079);
    			add_location(b1, file, 55, 29, 1394);
    			attr_dev(label1, "for", "year");
    			attr_dev(label1, "class", "svelte-1glg9vd");
    			add_location(label1, file, 55, 4, 1369);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "year");
    			attr_dev(input1, "class", "svelte-1glg9vd");
    			add_location(input1, file, 56, 4, 1418);
    			add_location(button1, file, 57, 4, 1476);
    			attr_dev(form1, "class", "svelte-1glg9vd");
    			add_location(form1, file, 54, 2, 1303);
    			add_location(b2, file, 60, 29, 1611);
    			attr_dev(label2, "for", "date");
    			attr_dev(label2, "class", "svelte-1glg9vd");
    			add_location(label2, file, 60, 4, 1586);
    			attr_dev(input2, "type", "date");
    			attr_dev(input2, "name", "date");
    			attr_dev(input2, "class", "svelte-1glg9vd");
    			add_location(input2, file, 61, 4, 1635);
    			add_location(button2, file, 62, 4, 1691);
    			attr_dev(form2, "class", "svelte-1glg9vd");
    			add_location(form2, file, 59, 2, 1520);
    			attr_dev(h2, "class", "svelte-1glg9vd");
    			add_location(h2, file, 64, 2, 1735);
    			attr_dev(div, "class", "layer steps svelte-1glg9vd");
    			add_location(div, file, 65, 2, 1755);
    			attr_dev(main, "class", "svelte-1glg9vd");
    			add_location(main, file, 47, 0, 1045);
    		},
