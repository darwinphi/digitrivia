    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 46, 2, 996);
    			add_location(b0, file, 48, 31, 1116);
    			attr_dev(label0, "for", "number");
    			attr_dev(label0, "class", "svelte-1u5rshg");
    			add_location(label0, file, 48, 4, 1089);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "name", "number");
    			attr_dev(input0, "class", "svelte-1u5rshg");
    			add_location(input0, file, 49, 4, 1139);
    			add_location(button0, file, 50, 4, 1201);
    			attr_dev(form0, "class", "svelte-1u5rshg");
    			add_location(form0, file, 47, 2, 1021);
    			add_location(b1, file, 53, 29, 1336);
    			attr_dev(label1, "for", "year");
    			attr_dev(label1, "class", "svelte-1u5rshg");
    			add_location(label1, file, 53, 4, 1311);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "year");
    			attr_dev(input1, "class", "svelte-1u5rshg");
    			add_location(input1, file, 54, 4, 1360);
    			add_location(button1, file, 55, 4, 1418);
    			attr_dev(form1, "class", "svelte-1u5rshg");
    			add_location(form1, file, 52, 2, 1245);
    			add_location(b2, file, 58, 29, 1553);
    			attr_dev(label2, "for", "date");
    			attr_dev(label2, "class", "svelte-1u5rshg");
    			add_location(label2, file, 58, 4, 1528);
    			attr_dev(input2, "type", "date");
    			attr_dev(input2, "name", "date");
    			attr_dev(input2, "class", "svelte-1u5rshg");
    			add_location(input2, file, 59, 4, 1577);
    			add_location(button2, file, 60, 4, 1633);
    			attr_dev(form2, "class", "svelte-1u5rshg");
    			add_location(form2, file, 57, 2, 1462);
    			attr_dev(h2, "class", "svelte-1u5rshg");
    			add_location(h2, file, 62, 2, 1677);
    			attr_dev(main, "class", "svelte-1u5rshg");
    			add_location(main, file, 45, 0, 987);
    		},
